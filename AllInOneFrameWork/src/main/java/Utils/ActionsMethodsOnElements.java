...
/**
 * This class contains All Elements related methods Example: present, enable,
 * selected, disable, click, sendKeys, tap, navigate, etc...
 *
 */
public class ActionsMethodsOnElements {
	...
	public static boolean isPresent(MobileElement element) {
		...
		try {
			...
			Log.message("Unable to validate presence of the element " + element + " and the error message is "
					+ e.getMessage());
		}
		return status;
	}
	...
	public static boolean isEnable(MobileElement element) {
		...
		try {
			...
			Log.message("Unable to validate state of the element " + element + " and the error message is "
					+ e.getMessage());
		}
		return status;
	}
	...
	public static boolean enterText(MobileElement element, String text) {
		...
		try {
			...
			Log.message("Unable to enter the text " + text + " to the element " + element + " and the error message is "
					+ e.getMessage());
		}
		return status;
	}
	...
	public static boolean getText(MobileElement element) {
		...
		try {
			...
			Log.message("Unable to get the text from the element " + element + " and the error message is "
					+ e.getMessage());
		}
		return status;
	}
	...
	public static boolean getAtributeValue(MobileElement element, String atributeValue) {
		...
		try {
			...
			Log.message("Unable to get the attribute value from the element " + element + " and the error message is "
					+ e.getMessage());
		}
		return status;
	}
	...
	public static boolean longPress(AppiumDriver driver, MobileElement element, int seconds) {
		try {

			TouchAction touchAction = new TouchAction(driver);
			touchAction.longPress(LongPressOptions.longPressOptions().withDuration(Duration.ofSeconds(seconds))
					.withElement(ElementOption.element(element))).perform();

			return true;

		} catch (Exception e) {
			Log.message("Unable to perform long press on the element " + element + " and The error message is "
					+ e.getMessage());
		}
		return false;
	}
